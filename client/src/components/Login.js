...
class Login extends Component {
  responseGoogle (googleUser) {
    ...
    axios({ method: 'post', url: `${user}/login`, headers: { 'Authorization': authResponse.id_token } })
      .then((res) => {
      ...
      <div className='hero'>
        <div className='hero-body'>
          <div className='container'>
            <h1 className='title' style={{ margin: 30 }} >Sonya Falcon</h1>
            <h2 className='subtitle' style={{ margin: 30 }}>Login</h2>
