        ...
        <div className="modal-card">
          ...
          <footer className="modal-card-foot">
            <button
              ...
              onClick={() => this.props.closeModal(this.state.chosenMedia)}
            >
              Choose
            </button>
